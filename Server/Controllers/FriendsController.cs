...
namespace codegin_server.Controllers
{
    public class FriendsController : Controller
    {
        ...
        public FriendsController(CodeGinContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,User1Id,User2Id,State")] Friend friend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,User1Id,User2Id,State")] Friend friend)
        {
            if (id != friend.Id)
            {
                return NotFound();
